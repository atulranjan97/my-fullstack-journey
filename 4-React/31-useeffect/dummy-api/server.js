...
// CORS (Cross-Origin Resource Sharing) middleware allows our React frontend (running on localhost:5173) to make requests to this Express backend (running on localhost:5000) by adding necessary HTTP headers
...
app.get("/todos", (req, res) => {
  // Send the todos array as a JSON response to the client
  // res.json() automatically sets Content-Type header to application/json
  // and converts the JavaScript array into JSON string format
  res.json(todos);
});

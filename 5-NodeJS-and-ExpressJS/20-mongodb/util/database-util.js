...
// - Cluster name: airbnb
// - Database name: airbnb (not nboh2yb - that's part of the cluster URL)
// - Additional options like retryWrites and w=majority for reliability
const url = "mongodb+srv://atulranjan97:jin97kMongoDb*@airbnb.nboh2yb.mongodb.net/?retryWrites=true&w=majority&appName=Airbnb";
...
// This allows other files to establish the database connection

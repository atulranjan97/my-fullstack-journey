...
exports.getIndex = (req, res, next) => {
    ...
    Home.find().then(registeredHomes => {
        res.render('store/index', {homes: registeredHomes, pageTitle: 'Humara airbnb', isLoggedIn: req.isLoggedIn});
    })
}
...
exports.getHomes = (req, res, next) => {
    ...
    Home.find().then(registeredHomes => {
        ...
        res.render('store/homes', {homes: registeredHomes, pageTitle: 'Humara airbnb', isLoggedIn: req.isLoggedIn});
    });
}
